...
jq '.channel_group.groups.Application.groups."receiverbank-crossborder-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.0.2.15","port": 7007}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
