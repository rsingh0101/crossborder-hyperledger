...
jq '.channel_group.groups.Application.groups."centralforexbank-crossborder-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.0.2.15","port": 7006}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
